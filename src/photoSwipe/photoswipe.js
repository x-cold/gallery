...
(function(root, factory) {
  ...
  'use strict';
  const PhotoSwipe = function(template, UiClass, items, options) {
      ...
      detectFeatures() {
        ...
        if (!features.raf) {
          ...
          features.raf = function(fn) {
            ...
            const id = window.setTimeout(function() { fn(currTime + timeToCall); }, timeToCall);
 ...
 */
    ...
    const publicMethods = {
      ...
      init() {
        ...
        // init
        if (UiClass) {
          const ui = self.ui = new UiClass(self, framework);
          ui.init();
        }
	 ...
	 */
      ...
      updateSize(force) {
        ...
        if (!_isFixedPosition && _options.modal) {
          const windowScrollY = framework.getScrollY();
 ...
 */
    ...
    var _gestureStartTime,
      ...
      _onDragMove = function(e) {
        ...
        if (_pointerEventEnabled) {
          const pointerIndex = framework.arraySearch(_currPointers, e.pointerId, 'id');
          if (pointerIndex > -1) {
    ...
    _registerModule('Gestures', {
      publicMethods: {
        ...
        initGestures() {
          ...
          const addEventNames = function(pref, down, move, up, cancel) {
    ...
    _registerModule('Controller', {
      ...
      publicMethods: {
        ...
        setContent(holder, index) {
          ...
          const baseDiv = item.container = framework.createEl('pswp__zoom-wrap');
          ...
          if (item.src && !item.loadError && !item.loaded) {
            ...
            if (framework.features.transform) {
              ...
              const placeholder = framework.createEl(placeholderClassName, item.msrc ? 'img' : '');
              if (item.msrc) {
    ...
    _registerModule('History', {
      ...
      publicMethods: {
        initHistory() {
          ...
          const returnToOriginal = function() {
            _hashReseted = true;
            if (!_closedFromURL) {
